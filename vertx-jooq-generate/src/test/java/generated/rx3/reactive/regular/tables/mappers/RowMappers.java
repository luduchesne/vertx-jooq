package generated.rx3.reactive.regular.tables.mappers;
...
public class RowMappers {
        ...
        public static Function<Row,generated.rx3.reactive.regular.tables.pojos.Author> getAuthorMapper() {
                return row -> {
                        generated.rx3.reactive.regular.tables.pojos.Author pojo = new generated.rx3.reactive.regular.tables.pojos.Author();
        ...
        public static Function<Row,generated.rx3.reactive.regular.tables.pojos.Book> getBookMapper() {
                return row -> {
                        generated.rx3.reactive.regular.tables.pojos.Book pojo = new generated.rx3.reactive.regular.tables.pojos.Book();
                        pojo.setId(row.getInteger("id"));
        ...
        public static Function<Row,generated.rx3.reactive.regular.tables.pojos.Something> getSomethingMapper() {
                return row -> {
                        generated.rx3.reactive.regular.tables.pojos.Something pojo = new generated.rx3.reactive.regular.tables.pojos.Something();
                        ...
                        pojo.setSomeenum(java.util.Arrays.stream(generated.rx3.reactive.regular.enums.Someenum.values()).filter(td -> td.getLiteral().equals(row.getString("someEnum"))).findFirst().orElse(null));
                        ...
                        pojo.setSomecustomjsonobject(generated.rx3.reactive.regular.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.rowConverter().fromRow(key->row.get(generated.rx3.reactive.regular.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.rowConverter().fromType(),key),"someCustomJsonObject"));
        ...
        public static Function<Row,generated.rx3.reactive.regular.tables.pojos.Somethingcomposite> getSomethingcompositeMapper() {
                return row -> {
                        generated.rx3.reactive.regular.tables.pojos.Somethingcomposite pojo = new generated.rx3.reactive.regular.tables.pojos.Somethingcomposite();
                        pojo.setSomeid(row.getInteger("someId"));
        ...
        public static Function<Row,generated.rx3.reactive.regular.tables.pojos.Somethingwithoutjson> getSomethingwithoutjsonMapper() {
                return row -> {
                        generated.rx3.reactive.regular.tables.pojos.Somethingwithoutjson pojo = new generated.rx3.reactive.regular.tables.pojos.Somethingwithoutjson();
                        pojo.setSomeid(row.getInteger("someId"));
                        pojo.setSomestring(row.getString("someString"));
                        return pojo;
                };
