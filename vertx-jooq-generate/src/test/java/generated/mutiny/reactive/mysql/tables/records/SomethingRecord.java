...
public class SomethingRecord extends UpdatableRecordImpl<SomethingRecord> implements VertxPojo, Record11<Integer, String, Long, Short, Integer, Double, BigDecimal, SomethingSomeenum, JsonObject, JsonArray, LocalDateTime>, ISomething {
    ...
    public SomethingSomeenum getSomeenum() {
        return (SomethingSomeenum) get(7);
    }
    ...
    @Override
    public Row11<Integer, String, Long, Short, Integer, Double, BigDecimal, SomethingSomeenum, JsonObject, JsonArray, LocalDateTime> valuesRow() {
    ...
    @Override
    public Field<SomethingSomeenum> field8() {
    ...
    @Override
    public SomethingSomeenum component8() {
        return getSomeenum();
    }
    ...
    @Override
    public SomethingSomeenum value8() {
        return getSomeenum();
    }
    ...
    @Override
    public SomethingRecord value7(BigDecimal value) {
        setSomedecimal(value);
        return this;
    }

    @Override
    public SomethingRecord value8(SomethingSomeenum value) {
        setSomeenum(value);
        return this;
    }
    ...
    @Override
    public SomethingRecord values(Integer value1, String value2, Long value3, Short value4, Integer value5, Double value6, BigDecimal value7, SomethingSomeenum value8, JsonObject value9, JsonArray value10, LocalDateTime value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SomethingRecord(Integer someid, String somestring, Long somehugenumber, Short somesmallnumber, Integer someregularnumber, Double somedouble, BigDecimal somedecimal, SomethingSomeenum someenum, JsonObject somejsonobject, JsonArray somejsonarray, LocalDateTime sometimestamp) {
        super(Something.SOMETHING);
     ...
     * Create a detached, initialised SomethingRecord
     */
    public SomethingRecord(generated.mutiny.reactive.mysql.tables.pojos.Something value) {
        super(Something.SOMETHING);
