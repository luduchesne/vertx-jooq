...
public class RowMappers {
        ...
        public static Function<Row,generated.mutiny.reactive.regular.tables.pojos.Author> getAuthorMapper() {
                return row -> {
                        generated.mutiny.reactive.regular.tables.pojos.Author pojo = new generated.mutiny.reactive.regular.tables.pojos.Author();
        ...
        public static Function<Row,generated.mutiny.reactive.regular.tables.pojos.Book> getBookMapper() {
                return row -> {
                        generated.mutiny.reactive.regular.tables.pojos.Book pojo = new generated.mutiny.reactive.regular.tables.pojos.Book();
                        pojo.setId(row.getInteger("id"));
