package generated.mutiny.reactive.guice.tables.mappers;
...
public class RowMappers {
        ...
        public static Function<Row,generated.mutiny.reactive.guice.tables.pojos.Something> getSomethingMapper() {
                return row -> {
                        ...
                        pojo.setSomeenum(java.util.Arrays.stream(generated.mutiny.reactive.guice.enums.Someenum.values()).filter(td -> td.getLiteral().equals(row.getString("someEnum"))).findFirst().orElse(null));
                        ...
                        pojo.setSomecustomjsonobject(generated.mutiny.reactive.guice.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.rowConverter().fromRow(key->row.get(generated.mutiny.reactive.guice.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.rowConverter().fromType(),key),"someCustomJsonObject"));
                        ...
                        pojo.setSomestringaslist(generated.mutiny.reactive.guice.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_COMMASEPARATEDSTRINGINTOLISTCONVERTER_INSTANCE.rowConverter().fromRow(key->row.get(generated.mutiny.reactive.guice.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_COMMASEPARATEDSTRINGINTOLISTCONVERTER_INSTANCE.rowConverter().fromType(),key),"someStringAsList"));
                        return pojo;
                };
        }

        public static Function<Row,generated.mutiny.reactive.guice.tables.pojos.Somethingcomposite> getSomethingcompositeMapper() {
                return row -> {
                        generated.mutiny.reactive.guice.tables.pojos.Somethingcomposite pojo = new generated.mutiny.reactive.guice.tables.pojos.Somethingcomposite();
                        pojo.setSomeid(row.getInteger("someId"));
        ...
        public static Function<Row,generated.mutiny.reactive.guice.tables.pojos.Somethingwithoutjson> getSomethingwithoutjsonMapper() {
                return row -> {
                        generated.mutiny.reactive.guice.tables.pojos.Somethingwithoutjson pojo = new generated.mutiny.reactive.guice.tables.pojos.Somethingwithoutjson();
                        pojo.setSomeid(row.getInteger("someId"));
                        pojo.setSomestring(row.getString("someString"));
                        return pojo;
                };
