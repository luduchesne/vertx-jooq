...
public class Something extends TableImpl<SomethingRecord> {
     ...
     */
    public final TableField<SomethingRecord, Someenum> SOMEENUM = createField(DSL.name("someEnum"), SQLDataType.VARCHAR.defaultValue(DSL.field(DSL.raw("'FOO'::\"someEnum\""), SQLDataType.VARCHAR)).asEnumDataType(generated.rx.reactive.regular.enums.Someenum.class), this, "");
