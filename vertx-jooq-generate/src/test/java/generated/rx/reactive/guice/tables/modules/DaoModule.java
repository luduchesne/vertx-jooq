...
public class DaoModule extends AbstractModule {
        ...
        protected void configure() {
                bind(new TypeLiteral<VertxDAO<generated.rx.reactive.guice.tables.records.AuthorRecord, generated.rx.reactive.guice.tables.pojos.Author, java.lang.Integer>>() {}).to(generated.rx.reactive.guice.tables.daos.AuthorDao.class).asEagerSingleton();
                bind(new TypeLiteral<VertxDAO<generated.rx.reactive.guice.tables.records.BookRecord, generated.rx.reactive.guice.tables.pojos.Book, java.lang.Integer>>() {}).to(generated.rx.reactive.guice.tables.daos.BookDao.class).asEagerSingleton();
