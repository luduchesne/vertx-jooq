...
public class RowMappers {
        ...
        public static Function<Row,generated.rx.reactive.guice.tables.pojos.Author> getAuthorMapper() {
                return row -> {
                        generated.rx.reactive.guice.tables.pojos.Author pojo = new generated.rx.reactive.guice.tables.pojos.Author();
        ...
        public static Function<Row,generated.rx.reactive.guice.tables.pojos.Book> getBookMapper() {
                return row -> {
                        generated.rx.reactive.guice.tables.pojos.Book pojo = new generated.rx.reactive.guice.tables.pojos.Book();
                        pojo.setId(row.getInteger("id"));
