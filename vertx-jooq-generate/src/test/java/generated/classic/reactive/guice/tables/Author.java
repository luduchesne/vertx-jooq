 ...
 */
package generated.classic.reactive.guice.tables;


import generated.classic.reactive.guice.Keys;
import generated.classic.reactive.guice.Vertx;
...
public class Author extends TableImpl<AuthorRecord> {
    ...
    /**
     * The reference instance of <code>vertx.AUTHOR</code>
     */
    ...
    /**
     * The column <code>vertx.AUTHOR.id</code>.
     */
    public final TableField<AuthorRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>vertx.AUTHOR.name</code>.
     */
    public final TableField<AuthorRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(512), this, "");
    ...
    /**
     * Create an aliased <code>vertx.AUTHOR</code> table reference
     */
    ...
    /**
     * Create a <code>vertx.AUTHOR</code> table reference
     */
    public Author() {
