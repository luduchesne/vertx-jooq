...
public class DaoModule extends AbstractModule {
        ...
        protected void configure() {
                bind(new TypeLiteral<VertxDAO<generated.classic.reactive.guice.tables.records.AuthorRecord, generated.classic.reactive.guice.tables.pojos.Author, java.lang.Integer>>() {}).to(generated.classic.reactive.guice.tables.daos.AuthorDao.class).asEagerSingleton();
                bind(new TypeLiteral<VertxDAO<generated.classic.reactive.guice.tables.records.BookRecord, generated.classic.reactive.guice.tables.pojos.Book, java.lang.Integer>>() {}).to(generated.classic.reactive.guice.tables.daos.BookDao.class).asEagerSingleton();
