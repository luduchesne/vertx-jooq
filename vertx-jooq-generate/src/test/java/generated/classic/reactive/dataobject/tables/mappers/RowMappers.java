...
public class RowMappers {
        ...
        public static Function<Row,generated.classic.reactive.dataobject.tables.pojos.Author> getAuthorMapper() {
                return row -> {
                        generated.classic.reactive.dataobject.tables.pojos.Author pojo = new generated.classic.reactive.dataobject.tables.pojos.Author();
        ...
        public static Function<Row,generated.classic.reactive.dataobject.tables.pojos.Book> getBookMapper() {
                return row -> {
                        generated.classic.reactive.dataobject.tables.pojos.Book pojo = new generated.classic.reactive.dataobject.tables.pojos.Book();
                        pojo.setId(row.getInteger("id"));
