...
public class SomethingRecord extends UpdatableRecordImpl<SomethingRecord> implements VertxPojo, Record11<Integer, String, Long, Short, Integer, BigDecimal, Boolean, Double, JsonObject, JsonArray, LocalDateTime> {
     ...
     * Create a detached, initialised SomethingRecord
     */
    public SomethingRecord(generated.classic.jdbc.custom.vertx.tables.pojos.Something value) {
        super(Something.SOMETHING);
